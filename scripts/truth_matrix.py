...
SCENARIOS = {
    ...
    "S4-named-restored-verify": ("dns/verify", "single", "-", "restored", "-"),
    ...
    "S7-restored-verify": ("multi/verify", "single", "-", "restored", "-"),
    "S7b-krb5kdc-and-certmonger-down": ("multi", "single", "krb5kdc + certmonger stopped", "two independent stopped services", "lab restore (both fixes offered, not applied)"),
    "S7b-certmonger-fix-offered": ("multi", "single", "krb5kdc + certmonger stopped", "certmonger stopped (not masked)", "-"),
